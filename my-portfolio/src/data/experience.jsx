export const experience = [
  ...
  },
  {
    ...
    stack: ['PaddleOCR', 'DistilBERT', 'Web Scraping'],
    description: [
      <>
        Achieved over <strong>84% accuracy</strong> in detecting Regions of Interest using <strong>PaddleOCR</strong> and <strong>DistilBERT</strong>.
      </>,
      <>
        Led a team of <strong>6</strong> to research <strong>Region of Interest</strong> detection in sports footage.
      </>,
      <>
        Curated a publicly available dataset for model training by extracting data through <strong>web scraping</strong>, released under the <strong>Apache 2.0 license</strong>.
      </>,
    ],
  },
];
